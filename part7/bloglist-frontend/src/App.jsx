...
const App = () => {
  ...
  const createBlog = async (blogObject) => {
    try {
      ...
      sendNotification(`a new blog "${savedBlog.title}" added`, false)
    } catch (exception) {
      sendNotification(exception.response.data.error, true)
    }
  }
  ...
  const deleteBlog = async (id) => {
    try {
      ...
      sendNotification('blog successfully deleted', false)
    } catch (exception) {
      sendNotification(exception.response.data.error, true)
    }
  }
